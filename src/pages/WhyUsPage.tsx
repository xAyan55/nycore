      ...
      <section className="relative py-24 md:py-32 flex items-center justify-center overflow-hidden grid-bg">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center relative z-10 w-full">
          ...
          >
            ...
            <span className="text-gradient font-black">Proven Superiority</span>
          </motion.h1>
          ...
          >
            Explore our architectural specifications, networking routes, and premium transit transits compared directly against standard hosting setups.
          </motion.p>
        </div>
      </section>
