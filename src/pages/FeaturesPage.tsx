    ...
    <div className="pt-20 bg-dark-bg min-h-screen text-brand-cream overflow-hidden">
      ...
      <section className="relative py-24 md:py-32 flex items-center justify-center overflow-hidden grid-bg">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center relative z-10 w-full">
          ...
          >
            Next-Gen Hosting <br />
            <span className="text-gradient font-black">Performance</span>
          </motion.h1>
          ...
          >
            Take a deep dive into the bare-metal architecture, high-availability setups, and custom panel software that make Nyxore the industry leader in performance.
          </motion.p>
        </div>
      </section>
